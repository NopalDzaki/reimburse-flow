...
export function SharedReportCreate({ role, backHref }: SharedReportCreateProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="rounded-xl border border-border/50 bg-card p-6 shadow-sm space-y-5">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-border/50">
          ...
          <Button variant="gradient" type="submit" className="shadow-lg shadow-primary/20">Submit Report</Button>
        </div>
      </form>
    </div>
  )
