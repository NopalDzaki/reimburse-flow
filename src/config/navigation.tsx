...
export const USER_NAV: NavItem[] = [
  ...
  { title: "Reports", href: "/user/reports", icon: MessageSquareWarning, badge: 2 },
  { title: "Profile", href: "/user/profile", icon: UserCircle },
]

export const ADMIN_NAV: NavItem[] = [
  { title: "Dashboard", href: "/admin/dashboard", icon: LayoutDashboard },
  { title: "Review Queue", href: "/admin/review", icon: FileText, badge: 24 },
  { title: "Activity", href: "/admin/activity", icon: Activity },
  { title: "Reports", href: "/admin/reports", icon: MessageSquareWarning, badge: 1 },
...
export const FINANCE_NAV: NavItem[] = [
  ...
  { title: "Payment Queue", href: "/finance/payments", icon: Banknote, badge: 18 },
...
export const SUPERADMIN_NAV: NavItem[] = [
  ...
  { title: "Tickets", href: "/superadmin/tickets", icon: MessageSquareWarning, badge: 4 },
