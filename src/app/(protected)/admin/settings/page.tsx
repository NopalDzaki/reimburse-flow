		...
		<div className="max-w-3xl space-y-6">
			...
			<Card className="border border-border/60 shadow-sm">
				...
				<CardContent className="space-y-3 text-sm">
					{[
						{ label: "Urgent claims", desc: "Notify immediately when marked urgent." },
						{ label: "Reassigned to you", desc: "When claims reroute to your queue." },
						{ label: "SLA breaches", desc: "Alerts when items exceed 6h SLA." },
					].map((n) => (
