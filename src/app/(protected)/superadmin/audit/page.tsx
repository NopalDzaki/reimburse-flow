...
const AUDIT_ENTRIES = [
  {
    id: 1,
    actor: "system",
    event: "Rule Permission Changed",
    detail: "Superadmin updated 'Manager' role access in Acme Corp.",
    time: "08:12 AM TODAY",
    type: "info",
  },
  {
    ...
    detail: "Multiple failed attempts detected from IP 192.168.1.1.",
  ...
  },
  {
    ...
    detail: "'Fintech Innovators' added to the global system.",
  ...
  },
  {
    ...
    detail: "Global production API key was rotated successfully.",
  ...
  },
  {
    ...
    detail: "Jordan Devlin approved claim #TXN-90210 for $1,240.00.",
    time: "OCT 12, 01:45 PM",
    type: "success",
  },
  {
    id: 6,
    ...
    detail: "Riley North issued payment for claim #TXN-90210.",
    time: "OCT 12, 01:55 PM",
    type: "success",
  },
  {
    id: 7,
    ...
    detail: "Sarah Chen's role updated from 'User' to 'Admin'.",
