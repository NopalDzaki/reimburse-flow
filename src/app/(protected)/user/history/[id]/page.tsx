    ...
    return (
      <div className="space-y-6">
        <Button variant="ghost" asChild className="-ml-4 gap-2 text-muted-foreground hover:text-foreground">
          <Link href="/user/history"><ChevronLeft className="h-4 w-4" /> Back to History</Link>
        </Button>
        <EmptyState title="Claim Not Found" description="The reimbursement you are looking for does not exist or you don't have access." />
      </div>
    );
  }
