    ...
    <div className="max-w-4xl space-y-6">
      ...
      <Card className="border border-border/60 shadow-sm">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            <Shield className="h-4 w-4 text-success" /> Dual control required
            over $10k
          </div>
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            <CreditCard className="h-4 w-4 text-primary" /> Default disburser:
            Citi Treasury
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Escalates to Controller above this cap.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Prevents unexpected liquidity drain.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Fallback to wire for urgent claims.
            </p>
          </div>
          <div className="space-y-2">
