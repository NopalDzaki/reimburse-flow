    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-background p-6 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-lg space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground">Select a role template to explore the financial app.</p>
        </div>

        <Card className="border-border/50 shadow-xl shadow-background/50">
          <CardHeader className="text-center pb-4">
            <CardTitle>Development Sandbox</CardTitle>
            <CardDescription>Login bypass enabled for testing roles.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            >
              ...
              <div className="flex flex-col items-start leading-tight">
                <span className="font-semibold text-base font-heading">Mock as standard User</span>
                <span className="text-xs text-muted-foreground font-normal">Can submit claims and open tickets.</span>
              </div>
            </Button>
            ...
            >
              ...
              <div className="flex flex-col items-start leading-tight">
                <span className="font-semibold text-base font-heading">Mock as Manager (Admin)</span>
                <span className="text-xs text-muted-foreground font-normal">Can review and approve pending claims.</span>
              </div>
            </Button>
            ...
            >
              ...
              <div className="flex flex-col items-start leading-tight">
                <span className="font-semibold text-base font-heading">Mock as Finance</span>
                <span className="text-xs text-muted-foreground font-normal">Can monitor liquidity and issue payments.</span>
              </div>
            </Button>
            ...
            >
              ...
              <div className="flex flex-col items-start leading-tight">
                <span className="font-semibold text-base font-heading">Mock as Superadmin</span>
                <span className="text-xs text-muted-foreground font-normal">Has global audit and helpdesk access.</span>
              </div>
            </Button>
          </CardContent>
        </Card>
